...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        //根据用户id获取角色
        List<RoleEntity> roleEntityList = roleService.selectRoleByUserId(userEntity.getId());
        List<String> roleNameList = roleEntityList.stream().map(item -> item.getRoleName()).collect(Collectors.toList());
        ...
        //根据用户id获取操作权限值
        List<String> permissionValueList = permissionService.selectPermissionValueByUserId(userEntity.getId());
    ...
    public List<JSONObject> getMenu(String username) {
        ...
        //根据用户id获取用户菜单权限
        List<JSONObject> permissionList = permissionService.selectPermissionByUserId(userEntity.getId());
